...
serum_cholesterol_mg_per_dl = st.number_input("Serum Cholesterol (mg/dl)", 100, 600, 200)
...
slope_of_peak_exercise_st_segment = st.selectbox("Slope of ST Segment (0–2)", [0, 1, 2])
